...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_l093v5c', 'template_doyo7b8', formRef.current, {
            publicKey: 'NPumJ7GnIPyN1T4JN',}
        )
          .then(() => {
             setSuccess(true);
             setError(false);
  ...
  return (
    <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
        <motion.div className="letsContact" variants={variants}>
            <motion.h1 variants={variants}>Let&#39;s work together</motion.h1>
        </motion.div>
        <motion.div className="contactForm" variants={variants} initial="initial" whileInView="animate">
  <motion.div className="mailSvg" initial={{ opacity: 1 }} whileInView={{ opacity: 0 }} transition={{ delay: 2, duration: 1 }}>
    <svg width="400px" height="400px" viewBox="0 0 1024 1024" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg">
    <motion.path
              strokeWidth={0.2}
              fill="none"
            ...
            <path d="M177.3 324c-2.1 3.8-4.2 7.6-6.2 11.4L512 673.6l191-192.4c-1.4-20.3-4.1-40.2-8.1-59.6L512 543.9 177.3 324z" fill="orange" />
